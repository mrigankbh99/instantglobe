  ...
  return (
    <section className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-30">
        <div className="absolute top-20 left-10 w-72 h-72 bg-theme-blue/10 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-theme-green/10 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pt-10 md:pt-20 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 order-2 md:order-1">
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <span className="inline-block bg-theme-blue/10 text-theme-blue text-xs font-medium px-4 py-1.5 rounded-full mb-4">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            Send money to <span className="text-theme-green">India</span> instantly with <span className="text-theme-blue">Google rates</span> and <span className="underline decoration-theme-blue decoration-2 underline-offset-4">Zero Fees</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            <Button className="bg-theme-blue hover:bg-theme-blue/90 text-white rounded-full px-8 py-6 text-lg font-medium transition-all duration-300 transform hover:scale-105">
              Start Sending Now
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 pb-10 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
        <div className="glassmorphism rounded-xl p-6 mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center justify-center md:justify-start space-x-4 p-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-theme-blue/20 flex items-center justify-center">
